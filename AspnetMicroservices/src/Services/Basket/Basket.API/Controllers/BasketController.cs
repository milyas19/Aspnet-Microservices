...
namespace Basket.API.Controllers
{
    ...
    public class BasketController : ControllerBase
    {
        ...
        {
            //legge til refranse til grpc service i projekt fil
            //koblet og konsumere Grpc tjenesten med discount.Grpc
            //Hente produkt pris/rabatt og oppdatere handlekurv
